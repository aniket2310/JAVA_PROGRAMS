...
interface Employee1111          //by default interface keyword is a abstract
{
...
class Permenent_emp implements Employee1111
{
    @Override
    public void salary()
    {
...
class Contractual_emp implements Employee1111
{
    @Override
    public void salary()
    {
